# Generated by Django 4.1.13 on 2024-04-23 10:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_to', models.TextField(blank=True, help_text='Enter your email to be notified when the form is submitted', null=True, verbose_name='Notification To')),
                ('success_page_content', models.TextField(blank=True, help_text='You can override success page content at here. Support HTML syntax', null=True, verbose_name='Success Page Content')),
            ],
            options={
                'verbose_name': 'survey',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='surveys.useranswer', verbose_name='user answer')),
            ],
            options={
                'verbose_name': 'answer',
