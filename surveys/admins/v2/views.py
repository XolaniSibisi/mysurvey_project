...
from surveys.models import Survey, Question, TYPE_FIELD
from surveys.mixin import ContextTitleMixin
from surveys.admins.v2.forms import QuestionForm, QuestionWithChoicesForm, QuestionFormRatings


@method_decorator(staff_member_required, name='dispatch')
class AdminCreateQuestionView(ContextTitleMixin, CreateView):
    template_name = 'surveys/admins/question_form_v2.html'
